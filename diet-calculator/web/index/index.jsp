      ...
      <div class="header_section">
         <div class="header-nav">
            <nav class="navbar navbar-expand-lg navbar-light main_navbar">
               <div class="logo"><a href="index.html"><img class="logo" src="./images/logo.jpg" alt="logo"><h1 class="title">Diet Calculator</h1></a></div>
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  ...
                  <div class="user-logo"><a href=""><img src="images/user-logo.jpg" alt="user_logo"></a></div>
               </div>
            </nav>
         </div>
