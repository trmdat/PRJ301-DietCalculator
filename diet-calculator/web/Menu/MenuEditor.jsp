...
<body>
         ...
         <table class="table table-bordered text-center">
            ...
            <tbody>
               <tr>
                  ...
                  <td>
                     <input type="text"
                        class="bg-sky padding-5px-tb padding-15px-lr border-radius-5 margin-10px-bottom text-white font-size16 xs-font-size13"></input>
                     <div class="margin-10px-top font-size14">9:00-10:00</div>
                     <div class="font-size13 text-light-gray"><a href="" class="text-light-gray">Edit</a></div>
                  </td>
                  <td>
                     <span
   ...
   <div class="text-center">
      <a class="btn btn-success" target="__blank" href="Menu.html">Save</a>
   </div>
